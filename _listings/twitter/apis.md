...
- name: Twitter - Remove User From List
  x-api-slug: listsmembersdestroy-get
...
- name: Twitter - Get Memberships
  x-api-slug: listsmemberships-get
...
- name: Twitter - List Subscribers
  x-api-slug: listssubscribers-get
...
- name: Twitter - Add List Subscribers
  x-api-slug: listssubscriberscreate-post
...
- name: Twitter - Show List Subscribers
  x-api-slug: listssubscribersshow-get
...
- name: Twitter - Remove List Subscribers
  x-api-slug: listssubscribersdestroy-get
...
- name: Twitter - Add Users to List
  x-api-slug: listsmemberscreate-all-get
...
- name: Twitter - Show Members
  x-api-slug: listmembersshow-get
...
- name: Twitter - Add Member
  x-api-slug: listmemberscreate-post
...
- name: Twitter - Show List Subscriptions
  x-api-slug: listssubscriptions-get
...
- name: Twitter - Remove Members
  x-api-slug: listmembersdestroy-all-get
...
- name: Twitter - List Saved Searches
  x-api-slug: saved-searcheslist-get
...
- name: Twitter - Get Saved Search
  x-api-slug: saved-searchesshowid-get
...
- name: Twitter - Create Saved Search
  x-api-slug: saved-searchescreate-post
...
- name: Twitter - Destroy Saved Search
  x-api-slug: saved-searchesdestroyid-post
...
- name: Twitter - User Search
  x-api-slug: userssearch-json-get
...
- name: Twitter - User Contributees
  x-api-slug: userscontributees-get
...
- name: Twitter - User Contributors
  x-api-slug: userscontributors-get
...
- name: Twitter - Get Lat / Log
  x-api-slug: georeverse-geoncode-get
...
- name: Twitter - Get Similar Places
  x-api-slug: geosimilar-places-get
...
- name: Twitter - Show Place Trends
  x-api-slug: trendsplace-json-get
...
- name: Twitter - Show Available Trends
  x-api-slug: trendsavailable-json-get
...
- name: Twitter - Show Closes Trends
  x-api-slug: trendsclosest-json-get
...
- name: Twitter - Get Rate Limit Sttaus
  x-api-slug: applicationrate-limit-status-get
